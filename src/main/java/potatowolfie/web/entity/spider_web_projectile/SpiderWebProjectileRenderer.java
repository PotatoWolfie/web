...
public class
SpiderWebProjectileRenderer extends ProjectileEntityRenderer<SpiderWebProjectileEntity, ProjectileEntityRenderState> {
    ...
    public void render(ProjectileEntityRenderState renderState, MatrixStack matrices, OrderedRenderCommandQueue queue, CameraRenderState cameraRenderState) {
        ...
        queue.submitModel(
                ...
                renderState,
                matrices,
                RenderLayers.entityCutoutNoCull(this.getTexture(renderState)),
                renderState.light,
