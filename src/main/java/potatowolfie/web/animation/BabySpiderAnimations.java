...
public class BabySpiderAnimations {
	...
	public static final AnimationDefinition SPIDER_SHOOT = AnimationDefinition.Builder.withLength(0.9583F).looping()
		...
		.addAnimation("body1", new AnimationChannel(AnimationChannel.Targets.POSITION,
			...
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -0.02F, 0.11F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.7083F, KeyframeAnimations.posVec(0.0F, 0.9F, 0.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.9583F, KeyframeAnimations.posVec(0.0F, 0.25F, 0.25F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("leg0", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -20.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
	...
	public static final AnimationDefinition SPIDER_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("body1", new AnimationChannel(AnimationChannel.Targets.POSITION,
			...
			new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, 0.25F, 0.25F), AnimationChannel.Interpolations.CATMULLROM),
